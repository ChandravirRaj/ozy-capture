...
class DesktopScreenshotCaptureLinux extends MethodChannelDesktopScreenshotCapture {
  static void registerWith() {
    DesktopScreenshotCapturePlatform.instance = DesktopScreenshotCaptureLinux();
  }
}
